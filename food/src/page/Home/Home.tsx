    ...
    return (
      <div >
        ...
        <div className="w-full h-screen">
         <div className='fixed bottom-0 left-0 right-0 w-full h-2/3 m-auto'>
            <div className='w-1/2 h-2/3 ml-20'>
              ...
              <div className='mt-16 text-xl'><p>We are now accepting all inquiries for full buyouts for private events and holiday parties, any day of the week, day or night. 
              ...
              <div className='mt-16'>
              <span className='bg-accent-set-200 border border-slate-500 rounded-2xl px-6 py-2 cursor-pointer text-white'>Order Now </span>
              </div>
            </div>
